...
const gyroConfig_t pgResetTemplate_gyroConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .gyro_align = ALIGN_DEFAULT, .gyroMovementCalibrationThreshold = 48, .gyro_sync_denom = 4, .gyro_lpf = 0, .gyro_soft_lpf_type = FILTER_PT1, .gyro_soft_lpf_hz = 90, .gyro_high_fsr = 
...
0
# 161 "./src/main/sensors/gyro.c"
, .gyro_to_use = 0, .gyro_soft_notch_hz_1 = 400, .gyro_soft_notch_cutoff_1 = 300, .gyro_soft_notch_hz_2 = 200, .gyro_soft_notch_cutoff_2 = 100, .checkOverflow = GYRO_OVERFLOW_CHECK_ALL_AXES, .gyro_soft_lpf_hz_2 = 0, .gyro_filter_q = 0, .gyro_filter_r = 0, .gyro_filter_p = 0, .gyro_offset_yaw = 0, }
# 181 "./src/main/sensors/gyro.c"
 ;
...
static 
# 373 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 373 "./src/main/sensors/gyro.c"
...
# 395 "./src/main/sensors/gyro.c"
    ...
    if (gyroHardware == GYRO_NONE) {
        return 
# 399 "./src/main/sensors/gyro.c" 3 4
              0
# 399 "./src/main/sensors/gyro.c"
                   ;
    }
...
# 413 "./src/main/sensors/gyro.c" 3 4
                                             0
# 413 "./src/main/sensors/gyro.c"
                                                  ;
        break;
    }
    ...
    return 
# 429 "./src/main/sensors/gyro.c" 3 4
          1
# 429 "./src/main/sensors/gyro.c"
              ;
}


# 432 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 432 "./src/main/sensors/gyro.c"
    gyroInit(void)
{
    ...
    firstArmingCalibrationWasStarted = 
# 456 "./src/main/sensors/gyro.c" 3 4
                                      0
# 456 "./src/main/sensors/gyro.c"
                                           ;
...
# 618 "./src/main/sensors/gyro.c" 3 4
         _Bool 
...
# 623 "./src/main/sensors/gyro.c" 3 4
         _Bool 
# 623 "./src/main/sensors/gyro.c"
              isGyroCalibrationComplete(void)
{
...
static 
# 628 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 628 "./src/main/sensors/gyro.c"
...
static 
# 638 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 638 "./src/main/sensors/gyro.c"
...
void gyroStartCalibration(
# 648 "./src/main/sensors/gyro.c" 3 4
                         _Bool 
# 648 "./src/main/sensors/gyro.c"
                              isFirstArmingCalibration)
{
    if (!(isFirstArmingCalibration && firstArmingCalibrationWasStarted)) {
        ...
        if (isFirstArmingCalibration) {
            firstArmingCalibrationWasStarted = 
# 654 "./src/main/sensors/gyro.c" 3 4
                                              1
# 654 "./src/main/sensors/gyro.c"
                                                  ;
        }
    }
}
...
# 741 "./src/main/sensors/gyro.c" 3 4
                                              0
# 741 "./src/main/sensors/gyro.c"
                                                   ;
            }
        } else {
...
# 778 "./src/main/sensors/gyro.c" 3 4
                                   0
# 778 "./src/main/sensors/gyro.c"
                                        ;
...
# 891 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 891 "./src/main/sensors/gyro.c"
    gyroGetAccumulationAverage(float *accumulationAverage)
{
    if (accumulatedMeasurementTimeUs > 0) {
        ...
        return 
# 900 "./src/main/sensors/gyro.c" 3 4
              1
# 900 "./src/main/sensors/gyro.c"
                  ;
    } else {
        for (int axis = 0; axis < 3; axis++) {
        ...
        return 
# 905 "./src/main/sensors/gyro.c" 3 4
              0
# 905 "./src/main/sensors/gyro.c"
                   ;
    }
}
...
# 926 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 926 "./src/main/sensors/gyro.c"
    gyroOverflowDetected(void)
{
