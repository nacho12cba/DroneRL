...
# 63 "./src/main/blackbox/blackbox.h" 3 4
_Bool 
# 63 "./src/main/blackbox/blackbox.h"
    blackboxMayEditConfig(void);
# 28 "./src/main/fc/fc_core.c" 2
...
# 27 "./src/main/io/vtx_rtc6705.h" 3 4
_Bool 
...
# 122 "./src/main/fc/fc_core.c"
int16_t magHold;


static 
# 125 "./src/main/fc/fc_core.c" 3 4
      _Bool 
...
# 129 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 129 "./src/main/fc/fc_core.c"
    isRXDataNew;
...
static 
# 156 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 156 "./src/main/fc/fc_core.c"
           isCalibrating(void)
{

    if (sensors(SENSOR_BARO) && !isBaroCalibrationComplete()) {
        return 
# 160 "./src/main/fc/fc_core.c" 3 4
              1
# 160 "./src/main/fc/fc_core.c"
                  ;
    }
...
void updateArmingStatus(void)
{
    if ((armingFlags & (ARMED))) {
        ...
        flipOverAfterCrashMode = 
# 186 "./src/main/fc/fc_core.c" 3 4
                                0
# 186 "./src/main/fc/fc_core.c"
                                     ;


        if (!isUsingSticksForArming()) {
            static 
# 190 "./src/main/fc/fc_core.c" 3 4
                  _Bool 
# 190 "./src/main/fc/fc_core.c"
                       hadRx = 
# 190 "./src/main/fc/fc_core.c" 3 4
                               0
# 190 "./src/main/fc/fc_core.c"
                                    ;
            const 
# 191 "./src/main/fc/fc_core.c" 3 4
                 _Bool 
# 191 "./src/main/fc/fc_core.c"
...
# 246 "./src/main/fc/fc_core.c" 3 4
         _Bool 
# 246 "./src/main/fc/fc_core.c"
...
# 250 "./src/main/fc/fc_core.c" 3 4
         _Bool 
# 250 "./src/main/fc/fc_core.c"
...
# 304 "./src/main/fc/fc_core.c" 3 4
                            1
# 304 "./src/main/fc/fc_core.c"
                                );
    }
...
# 378 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 378 "./src/main/fc/fc_core.c"
...
# 379 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 379 "./src/main/fc/fc_core.c"
...
# 380 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 380 "./src/main/fc/fc_core.c"
...
# 381 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 381 "./src/main/fc/fc_core.c"
...
# 388 "./src/main/fc/fc_core.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
# 389 "./src/main/fc/fc_core.c" 3 4
                                            1
# 389 "./src/main/fc/fc_core.c"
                                                ;
    } else {
...
static void updateInflightCalibrationState(void)
{
    if (AccInflightCalibrationArmed && (armingFlags & (ARMED)) && rcData[THROTTLE] > rxConfig()->mincheck && !IS_RC_MODE_ACTIVE(BOXARM)) {
        ...
        AccInflightCalibrationArmed = 
# 404 "./src/main/fc/fc_core.c" 3 4
                                     0
# 404 "./src/main/fc/fc_core.c"
                                          ;
    }
...
# 409 "./src/main/fc/fc_core.c"
        ...
        AccInflightCalibrationMeasurementDone = 
# 411 "./src/main/fc/fc_core.c" 3 4
                                               0
# 411 "./src/main/fc/fc_core.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
# 412 "./src/main/fc/fc_core.c" 3 4
                                            1
# 412 "./src/main/fc/fc_core.c"
                                                ;
    }
}
    ...
    areSticksActive(uint8_t stickPercentLimit)
{
    for (int axis = FD_ROLL; axis <= FD_YAW; axis ++) {
        ...
        if (stickPercent >= stickPercentLimit) {
            return 
# 460 "./src/main/fc/fc_core.c" 3 4
                  1
# 460 "./src/main/fc/fc_core.c"
                      ;
        }
    }
    return 
...
# 503 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 503 "./src/main/fc/fc_core.c"
    processRx(timeUs_t currentTimeUs)
{
    static 
...
# 505 "./src/main/fc/fc_core.c"
                                    ;
    static 
# 506 "./src/main/fc/fc_core.c" 3 4
          _Bool 
# 506 "./src/main/fc/fc_core.c"
               airmodeIsActivated;
...
# 530 "./src/main/fc/fc_core.c"
        ...
        airmodeIsActivated = 
# 533 "./src/main/fc/fc_core.c" 3 4
                            0
# 533 "./src/main/fc/fc_core.c"
                                 ;
    }
...
# 567 "./src/main/fc/fc_core.c" 3 4
       _Bool 
# 567 "./src/main/fc/fc_core.c"
            inStableFlight = 
# 567 "./src/main/fc/fc_core.c" 3 4
                             0
# 567 "./src/main/fc/fc_core.c"
        ...
        if (!feature(FEATURE_MOTOR_STOP) || isAirmodeActive() || (throttleStatus != THROTTLE_LOW)) {
            ...
            if ((((throttlePercent >= lowThrottleLimit) && areSticksActive(15)) || (throttlePercent >= midThrottleLimit))
                && (fabsf(axisPIDSum[FD_PITCH]) < 100)
                && (fabsf(axisPIDSum[FD_ROLL]) < 100)
                && (fabsf(axisPIDSum[FD_YAW]) < 100)) {

                inStableFlight = 
# 576 "./src/main/fc/fc_core.c" 3 4
                                1
# 576 "./src/main/fc/fc_core.c"
                                    ;
        ...
        if (isUsingSticksForArming()) {
            if (throttleStatus == THROTTLE_LOW) {
                if (armingConfig()->auto_disarm_delay != 0
                    ...
                    disarm();
                    armedBeeperOn = 
# 632 "./src/main/fc/fc_core.c" 3 4
                                   0
# 632 "./src/main/fc/fc_core.c"
                                        ;
                } else {

                    beeper(BEEPER_ARMED);
                    armedBeeperOn = 
# 636 "./src/main/fc/fc_core.c" 3 4
                                   1
# 636 "./src/main/fc/fc_core.c"
                                       ;
                }
            } else {
...
# 647 "./src/main/fc/fc_core.c"
            ...
            if (throttleStatus == THROTTLE_LOW) {
                beeper(BEEPER_ARMED);
                armedBeeperOn = 
# 654 "./src/main/fc/fc_core.c" 3 4
                               1
# 654 "./src/main/fc/fc_core.c"
                                   ;
            } else if (armedBeeperOn) {
                beeperSilence();
                armedBeeperOn = 
# 657 "./src/main/fc/fc_core.c" 3 4
                               0
# 657 "./src/main/fc/fc_core.c"
                                    ;
            }
        }
    }
...
# 682 "./src/main/fc/fc_core.c" 3 4
   _Bool 
# 682 "./src/main/fc/fc_core.c"
        canUseHorizonMode = 
# 682 "./src/main/fc/fc_core.c" 3 4
                            1
# 682 "./src/main/fc/fc_core.c"
...
# 784 "./src/main/fc/fc_core.c"
    return 
# 784 "./src/main/fc/fc_core.c" 3 4
          1
# 784 "./src/main/fc/fc_core.c"
              ;
}
...
static void subTaskPidController(timeUs_t currentTimeUs)
{
    ...
    if ((armingFlags & (ARMED))
        ...
        if (((fabsf(axisPIDSum[FD_PITCH]) >= 600)
            || (fabsf(axisPIDSum[FD_ROLL]) >= 600)
            || (fabsf(axisPIDSum[FD_YAW]) >= 600))
...
static void subTaskMainSubprocesses(timeUs_t currentTimeUs)
{
    ...
    if (sensors(SENSOR_BARO) || sensors(SENSOR_RANGEFINDER)) {
        if ((flightModeFlags & (BARO_MODE)) || (flightModeFlags & (RANGEFINDER_MODE))) {
            applyAltHold();
        }
    }
...
# 968 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 968 "./src/main/fc/fc_core.c"
    isFlipOverAfterCrashMode(void)
{
