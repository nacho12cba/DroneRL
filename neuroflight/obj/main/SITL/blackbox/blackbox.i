...
const blackboxConfig_t pgResetTemplate_blackboxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .p_ratio = 32, .device = BLACKBOX_DEVICE_SERIAL, .record_acc = 1, .mode = BLACKBOX_MODE_NORMAL }
...
# 1192 "./src/main/blackbox/blackbox.c"
    ...
    switch (xmitState.headerIndex) {
        ...
        case 1: blackboxPrintfHeaderLine("Firmware revision", "%s %s (%s) %s", "Betaflight", "3" "." "3" "." "3", shortGitRevision, targetName); break;;
...
# 1416 "./src/main/blackbox/blackbox.c"
static 
# 1416 "./src/main/blackbox/blackbox.c" 3 4
                  _Bool 
# 1416 "./src/main/blackbox/blackbox.c"
                       blackboxShouldLogGpsHomeFrame(void)
{
    if (GPS_home[0] != gpsHistory.GPS_home[0] || GPS_home[1] != gpsHistory.GPS_home[1]
        ...
        return 
# 1420 "./src/main/blackbox/blackbox.c" 3 4
              1
# 1420 "./src/main/blackbox/blackbox.c"
                  ;
    }
    return 
...
# 1549 "./src/main/blackbox/blackbox.c" 3 4
               ((void *)0)
# 1549 "./src/main/blackbox/blackbox.c"
                   , 
# 1549 "./src/main/blackbox/blackbox.c" 3 4
                     ((void *)0)
# 1549 "./src/main/blackbox/blackbox.c"
