...
void protobuf_AddDesc_MotorSpeed_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\020MotorSpeed.proto\022\020sensor_msgs.msgs\"%\n\n"
    "MotorSpeed\022\027\n\013motor_speed\030\001 \003(\002B\002\020\001", 75);
...
MotorSpeed::MotorSpeed()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:sensor_msgs.msgs.MotorSpeed)
}
...
MotorSpeed::MotorSpeed(const MotorSpeed& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:sensor_msgs.msgs.MotorSpeed)
}
...
MotorSpeed::~MotorSpeed() {
  // @@protoc_insertion_point(destructor:sensor_msgs.msgs.MotorSpeed)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:sensor_msgs.msgs.MotorSpeed)
  motor_speed_.Clear();
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:sensor_msgs.msgs.MotorSpeed)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:sensor_msgs.msgs.MotorSpeed)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:sensor_msgs.msgs.MotorSpeed)
  return false;
#undef DO_
}
...
void MotorSpeed::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:sensor_msgs.msgs.MotorSpeed)
  // repeated float motor_speed = 1 [packed = true];
  ...
  // @@protoc_insertion_point(serialize_end:sensor_msgs.msgs.MotorSpeed)
}

::google::protobuf::uint8* MotorSpeed::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:sensor_msgs.msgs.MotorSpeed)
  // repeated float motor_speed = 1 [packed = true];
  if (this->motor_speed_size() > 0) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:sensor_msgs.msgs.MotorSpeed)
  return target;
}

int MotorSpeed::ByteSize() const {
// @@protoc_insertion_point(message_byte_size_start:sensor_msgs.msgs.MotorSpeed)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:sensor_msgs.msgs.MotorSpeed)
  ...
  const MotorSpeed* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const MotorSpeed>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:sensor_msgs.msgs.MotorSpeed)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:sensor_msgs.msgs.MotorSpeed)
    MergeFrom(*source);
  }
}

void MotorSpeed::MergeFrom(const MotorSpeed& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:sensor_msgs.msgs.MotorSpeed)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
// @@protoc_insertion_point(generalized_copy_from_start:sensor_msgs.msgs.MotorSpeed)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:sensor_msgs.msgs.MotorSpeed)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void MotorSpeed::clear_motor_speed() {
 ...
 float MotorSpeed::motor_speed(int index) const {
  // @@protoc_insertion_point(field_get:sensor_msgs.msgs.MotorSpeed.motor_speed)
  return motor_speed_.Get(index);
}
 void MotorSpeed::set_motor_speed(int index, float value) {
  motor_speed_.Set(index, value);
  // @@protoc_insertion_point(field_set:sensor_msgs.msgs.MotorSpeed.motor_speed)
}
 void MotorSpeed::add_motor_speed(float value) {
  motor_speed_.Add(value);
  // @@protoc_insertion_point(field_add:sensor_msgs.msgs.MotorSpeed.motor_speed)
}
 const ::google::protobuf::RepeatedField< float >&
MotorSpeed::motor_speed() const {
  // @@protoc_insertion_point(field_list:sensor_msgs.msgs.MotorSpeed.motor_speed)
  return motor_speed_;
}
 ::google::protobuf::RepeatedField< float >*
MotorSpeed::mutable_motor_speed() {
  // @@protoc_insertion_point(field_mutable_list:sensor_msgs.msgs.MotorSpeed.motor_speed)
  return &motor_speed_;
}
