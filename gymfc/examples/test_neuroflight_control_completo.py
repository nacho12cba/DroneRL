    ...
    with tf.Session() as sess:                                              ##
        ...
        for i in range(num_trials):     #por cada trial
            ...
            while True: ##hasta llegar al break
                ...
                else: ob, reward, done,  _ = env.step([0.4,0.4,0.4,0.4])                                   ##necesito buscar la función step. En base.py hay una función step, así que supongo que env siempre va a heredar de base.py. 
