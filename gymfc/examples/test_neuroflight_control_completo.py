    ...
    with tf.Session() as sess:                                              ##
        ...
        for i in range(num_trials):     #por cada trial
            ...
            while True: ##hasta llegar al break
                ...
                ob, reward, done,  _ = env.step([-1,-1,-1,-1])                                    ##la step de base.py devuelve: return state, reward, done, {}. No sé qué es llaves, pero bueno. Algo nulo, pero no sé por qué se correspondería con el _
