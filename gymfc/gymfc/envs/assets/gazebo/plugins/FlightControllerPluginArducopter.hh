...
class FlightControllerPluginArducopter : public WorldPlugin
{
  /// \brief Constructor.
  public: FlightControllerPluginArducopter();
  ...
  /// \brief Bind to the specified port to receive UDP packets
	public: bool BindAndConnect(const char *_address,const uint16_t _port_tx, const uint16_t _port_rx);
...
/// \brief
  ...
  /// \brief Pointer to the world
	...
	/// \brief Socket handle_rx
	public: int handle_rx;

	/// \brief Socket handle_tx
	public: int handle_tx;

    public: bool arduCopterOnline;

	public: struct sockaddr_in remaddr;

  public: struct sockaddr_in sockaddr_python;
  ...
  public: int connectionTimeoutMaxCount = 5;
