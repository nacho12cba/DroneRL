...
namespace gazebo
{
 ...
 // TODO Change link name to CoM
  ...
  const std::string kTrainingRigModelName = "attitude_control_training_rig"; //esto lo cambié para intentar que use un control rig que no tenga fijo el drone, es sólo prueba
